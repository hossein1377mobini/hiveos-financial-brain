...
| `01-Fundamentals/` | 🟡 در حال انجام | ✅ 01-accounting-principles ✅ 02-iranian-gaap تکمیل |
...
| فاز | محتوا | وضعیت |
|-----|-------|--------|
| **فاز 1 — مبانی (Basics)** | مفاهیم پایه، استانداردهای حسابداری ایران، چرخه حسابداری، کدینگ حساب‌ها | 🟡 (01-principles ✅) |
